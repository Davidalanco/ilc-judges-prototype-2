      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-yellow-100 border border-yellow-300 rounded-lg p-4 mb-6">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h3 className="font-bold text-yellow-800">🎨 PROTOTYPE REFERENCE VERSION</h3>
              <p className="text-yellow-700 text-sm">
                This page shows the EXACT target design and functionality. Use this as your visual reference when building the real implementation at <a href="/workflow" className="underline hover:text-yellow-900">/workflow</a>
              </p>
            </div>
          </div>
        </div>
        ...
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-4">Supreme Court Brief Workflow - PROTOTYPE</h1>
